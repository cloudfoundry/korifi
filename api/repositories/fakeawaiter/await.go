...
type FakeAwaiter[T k8s.RuntimeObjectWithStatusConditions[TT], TT any, L any, PL conditions.ObjectList[L]] struct {
	...
	AwaitConditionStub func(context.Context, repositories.Watcher, client.Object, string) (T, error)
	AwaitStateStub     func(context.Context, repositories.Watcher, client.Object, func(T) error) (T, error)
...
func (a *FakeAwaiter[T, TT, L, PL]) AwaitCondition(ctx context.Context, k8sClient repositories.Watcher, object client.Object, conditionType string) (T, error) {
...
func (a *FakeAwaiter[T, TT, L, PL]) AwaitConditionReturns(object T, err error) {
	a.AwaitConditionStub = func(ctx context.Context, k8sClient repositories.Watcher, object client.Object, conditionType string) (T, error) {
		return object.(T), err
	}
}
...
func (a *FakeAwaiter[T, TT, L, PL]) AwaitState(ctx context.Context, k8sClient repositories.Watcher, object client.Object, checkState func(T) error) (T, error) {
...
func (a *FakeAwaiter[T, TT, L, PL]) AwaitStateReturns(object T, err error) {
	a.AwaitStateStub = func(ctx context.Context, k8sClient repositories.Watcher, object client.Object, _ func(T) error) (T, error) {
		return object.(T), err
	}
}
