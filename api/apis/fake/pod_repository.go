...
type PodRepository struct {
	FetchPodStatsByAppGUIDStub        func(context.Context, client.Client, string, string) ([]repositories.PodStatsRecord, error)
...
func (fake *PodRepository) FetchPodStatsByAppGUID(arg1 context.Context, arg2 client.Client, arg3 string, arg4 string) ([]repositories.PodStatsRecord, error) {
	...
	fake.recordInvocation("FetchPodStatsByAppGUID", []interface{}{arg1, arg2, arg3, arg4})
...
func (fake *PodRepository) FetchPodStatsByAppGUIDCalls(stub func(context.Context, client.Client, string, string) ([]repositories.PodStatsRecord, error)) {
	fake.fetchPodStatsByAppGUIDMutex.Lock()
	defer fake.fetchPodStatsByAppGUIDMutex.Unlock()
	fake.FetchPodStatsByAppGUIDStub = stub
}

func (fake *PodRepository) FetchPodStatsByAppGUIDArgsForCall(i int) (context.Context, client.Client, string, string) {
	fake.fetchPodStatsByAppGUIDMutex.RLock()
	defer fake.fetchPodStatsByAppGUIDMutex.RUnlock()
