...
type CFRoleRepository struct {
	CreateRoleStub        func(context.Context, repositories.CreateRoleMessage) (repositories.RoleRecord, error)
	createRoleMutex       sync.RWMutex
	createRoleArgsForCall []struct {
		arg1 context.Context
		arg2 repositories.CreateRoleMessage
	}
...
func (fake *CFRoleRepository) CreateRole(arg1 context.Context, arg2 repositories.CreateRoleMessage) (repositories.RoleRecord, error) {
...
func (fake *CFRoleRepository) CreateRoleCalls(stub func(context.Context, repositories.CreateRoleMessage) (repositories.RoleRecord, error)) {
	fake.createRoleMutex.Lock()
	defer fake.createRoleMutex.Unlock()
	fake.CreateRoleStub = stub
}

func (fake *CFRoleRepository) CreateRoleArgsForCall(i int) (context.Context, repositories.CreateRoleMessage) {
	fake.createRoleMutex.RLock()
	defer fake.createRoleMutex.RUnlock()
