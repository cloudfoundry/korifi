...
type CFAppRepository struct {
	...
	FetchAppListStub        func(context.Context, client.Client, []string) ([]repositories.AppRecord, error)
...
func (fake *CFAppRepository) FetchAppList(arg1 context.Context, arg2 client.Client, arg3 []string) ([]repositories.AppRecord, error) {
	var arg3Copy []string
	if arg3 != nil {
	...
	fake.recordInvocation("FetchAppList", []interface{}{arg1, arg2, arg3Copy})
...
func (fake *CFAppRepository) FetchAppListCalls(stub func(context.Context, client.Client, []string) ([]repositories.AppRecord, error)) {
	fake.fetchAppListMutex.Lock()
	defer fake.fetchAppListMutex.Unlock()
	fake.FetchAppListStub = stub
}

func (fake *CFAppRepository) FetchAppListArgsForCall(i int) (context.Context, client.Client, []string) {
	fake.fetchAppListMutex.RLock()
	defer fake.fetchAppListMutex.RUnlock()
