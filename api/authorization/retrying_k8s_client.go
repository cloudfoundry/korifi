...
func (a AuthRetryingClient) Get(ctx context.Context, key client.ObjectKey, obj client.Object) error {
	return a.retryOnForbidden(func() error {
...
func (a AuthRetryingClient) retryOnForbidden(fn func() error, op string) error {
	count := 0
	return retry.OnError(a.backoff, k8serrors.IsForbidden, func() error {
		err := fn()
		if err != nil {
			count++
			a.logger.Info("k8s client returned forbidden", "op", op, "count", count, "error", err)
		}
		return err
	})
}
