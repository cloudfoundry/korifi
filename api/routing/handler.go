...
func (response *Response) writeTo(w http.ResponseWriter) error {
	...
	if response.contentType == "application/x-yaml" {
		return response.yamlEncoder(w)
	}
	return response.jsonEncoder(w)
}

func (response *Response) jsonEncoder(w http.ResponseWriter) error {
...
func (response *Response) yamlEncoder(w http.ResponseWriter) error {
