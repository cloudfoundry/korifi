...
var _ webhook.Validator = &CFApp{}

// ValidateCreate implements webhook.Validator so a webhook will be registered for the type
func (r *CFApp) ValidateCreate() error {
	cfapplog.Info("validate create", "name", r.Name)
...
func (r *CFApp) ValidateUpdate(old runtime.Object) error {
	cfapplog.Info("validate update", "name", r.Name)
...
func (r *CFApp) ValidateDelete() error {
	cfapplog.Info("validate delete", "name", r.Name)
