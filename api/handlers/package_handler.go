...
func (h *PackageHandler) UnauthenticatedRoutes() []Route {
	return []Route{}
}
...
func (h *PackageHandler) AuthenticatedRoutes() []Route {
	return []Route{
		...
		{Method: "POST", Pattern: PackagesPath, HandlerFunc: h.packageCreateHandler},
		{Method: "POST", Pattern: PackageUploadPath, HandlerFunc: h.packageUploadHandler},
		{Method: "GET", Pattern: PackageDropletsPath, HandlerFunc: h.packageListDropletsHandler},
	}
}
