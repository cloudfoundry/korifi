...
type AppsStateCollector struct {
...
func (fake *AppsStateCollector) CollectState(arg1 context.Context, arg2 authorization.Info, arg3 string, arg4 string) (manifest.AppState, error) {
...
func (fake *AppsStateCollector) CollectStateCallCount() int {
	fake.collectStateMutex.RLock()
	defer fake.collectStateMutex.RUnlock()
	return len(fake.collectStateArgsForCall)
}

func (fake *AppsStateCollector) CollectStateCalls(stub func(context.Context, authorization.Info, string, string) (manifest.AppState, error)) {
	fake.collectStateMutex.Lock()
	defer fake.collectStateMutex.Unlock()
	fake.CollectStateStub = stub
}

func (fake *AppsStateCollector) CollectStateArgsForCall(i int) (context.Context, authorization.Info, string, string) {
	fake.collectStateMutex.RLock()
	defer fake.collectStateMutex.RUnlock()
...
func (fake *AppsStateCollector) CollectStateReturns(result1 manifest.AppState, result2 error) {
	fake.collectStateMutex.Lock()
	defer fake.collectStateMutex.Unlock()
...
func (fake *AppsStateCollector) CollectStateReturnsOnCall(i int, result1 manifest.AppState, result2 error) {
	fake.collectStateMutex.Lock()
	defer fake.collectStateMutex.Unlock()
	fake.CollectStateStub = nil
...
func (fake *AppsStateCollector) Invocations() map[string][][]interface{} {
...
func (fake *AppsStateCollector) recordInvocation(key string, args []interface{}) {
...
var _ handlers.AppsStateCollector = new(AppsStateCollector)
