...
func (fake *PackageCleaner) Clean(arg1 context.Context, arg2 types.NamespacedName) error {
...
func (fake *PackageCleaner) CleanCallCount() int {
	fake.cleanMutex.RLock()
	defer fake.cleanMutex.RUnlock()
	return len(fake.cleanArgsForCall)
}

func (fake *PackageCleaner) CleanCalls(stub func(context.Context, types.NamespacedName) error) {
	fake.cleanMutex.Lock()
	defer fake.cleanMutex.Unlock()
	fake.CleanStub = stub
}

func (fake *PackageCleaner) CleanArgsForCall(i int) (context.Context, types.NamespacedName) {
	fake.cleanMutex.RLock()
	defer fake.cleanMutex.RUnlock()
...
func (fake *PackageCleaner) CleanReturns(result1 error) {
	fake.cleanMutex.Lock()
	defer fake.cleanMutex.Unlock()
	fake.CleanStub = nil
...
func (fake *PackageCleaner) CleanReturnsOnCall(i int, result1 error) {
	fake.cleanMutex.Lock()
	defer fake.cleanMutex.Unlock()
	fake.CleanStub = nil
...
func (fake *PackageCleaner) Invocations() map[string][][]interface{} {
...
func (fake *PackageCleaner) recordInvocation(key string, args []interface{}) {
...
var _ workloads.PackageCleaner = new(PackageCleaner)
