...
import (
	...
	"code.cloudfoundry.org/korifi/controllers/controllers/workloads/packages/fake"
...
func TestWorkloadsControllers(t *testing.T) {
	...
	RunSpecs(t, "CFPackage Controller Integration Suite")
}
