...
func (r *Reconciler) updateCFProcess(ctx context.Context, process *korifiv1alpha1.CFProcess, command string, serviceBindings []korifiv1alpha1.ServiceBinding) error {
	return k8s.PatchResource(ctx, r.k8sClient, process, func() {
		process.Spec.DetectedCommand = command
		process.Spec.ServiceBindings = serviceBindings
	})
}
...
func (r *Reconciler) createCFProcess(ctx context.Context, process korifiv1alpha1.ProcessType, cfApp *korifiv1alpha1.CFApp) (*korifiv1alpha1.CFProcess, error) {
	desiredCFProcess := &korifiv1alpha1.CFProcess{
		...
		Spec: korifiv1alpha1.CFProcessSpec{
			...
			// TODO: test ServiceBindings are set
