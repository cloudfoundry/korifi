...
func (in *ActualServiceBindingRef) DeepCopyInto(out *ActualServiceBindingRef) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ActualServiceBindingRef.
func (in *ActualServiceBindingRef) DeepCopy() *ActualServiceBindingRef {
	if in == nil {
		return nil
	}
	out := new(ActualServiceBindingRef)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AppWorkloadSpec) DeepCopyInto(out *AppWorkloadSpec) {
	*out = *in
	...
	if in.ServiceBindingRefs != nil {
		in, out := &in.ServiceBindingRefs, &out.ServiceBindingRefs
		*out = make([]ActualServiceBindingRef, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *CFAppSpec) DeepCopyInto(out *CFAppSpec) {
	*out = *in
	...
	if in.ServiceBindingRefs != nil {
		in, out := &in.ServiceBindingRefs, &out.ServiceBindingRefs
		*out = make([]ServiceBindingRef, len(*in))
		copy(*out, *in)
	}
}
...
func (in *CFAppStatus) DeepCopyInto(out *CFAppStatus) {
	*out = *in
	...
	if in.ActualServiceBindingRefs != nil {
		in, out := &in.ActualServiceBindingRefs, &out.ActualServiceBindingRefs
		*out = make([]ActualServiceBindingRef, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
