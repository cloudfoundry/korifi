...
func main() {
	...
	flag.StringVar(&gatewayName, "gateway-name", "korifi", "Path to the KUBECONFIG for the Korifi cluster.")
	flag.StringVar(&gatewayNamespace, "gateway-namespace", "korifi-gateway", "Path to the KUBECONFIG for the Korifi cluster.")
