...
type FakeCFRouteRepository struct {
...
func (fake *FakeCFRouteRepository) FetchRoute(arg1 client.Client, arg2 string) (repositories.RouteRecord, error) {
...
func (fake *FakeCFRouteRepository) FetchRouteCallCount() int {
	fake.fetchRouteMutex.RLock()
	defer fake.fetchRouteMutex.RUnlock()
	return len(fake.fetchRouteArgsForCall)
}

func (fake *FakeCFRouteRepository) FetchRouteCalls(stub func(client.Client, string) (repositories.RouteRecord, error)) {
	fake.fetchRouteMutex.Lock()
	defer fake.fetchRouteMutex.Unlock()
	fake.FetchRouteStub = stub
}

func (fake *FakeCFRouteRepository) FetchRouteArgsForCall(i int) (client.Client, string) {
	fake.fetchRouteMutex.RLock()
	defer fake.fetchRouteMutex.RUnlock()
...
func (fake *FakeCFRouteRepository) FetchRouteReturns(result1 repositories.RouteRecord, result2 error) {
	fake.fetchRouteMutex.Lock()
	defer fake.fetchRouteMutex.Unlock()
...
func (fake *FakeCFRouteRepository) FetchRouteReturnsOnCall(i int, result1 repositories.RouteRecord, result2 error) {
	fake.fetchRouteMutex.Lock()
	defer fake.fetchRouteMutex.Unlock()
	fake.FetchRouteStub = nil
...
func (fake *FakeCFRouteRepository) Invocations() map[string][][]interface{} {
...
func (fake *FakeCFRouteRepository) recordInvocation(key string, args []interface{}) {
...
var _ apis.CFRouteRepository = new(FakeCFRouteRepository)
