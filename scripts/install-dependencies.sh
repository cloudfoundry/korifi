...
curl -L "https://github.com/kubernetes-sigs/hierarchical-namespaces/releases/download/${HNC_VERSION}/hnc-manager.yaml" | sed "s/cpu: 100m/cpu: 1000m/" | kubectl apply -f-
